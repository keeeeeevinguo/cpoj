...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './test-case.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASE actions', async () => {
      const expectedActions = [
        {
