...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './submission-test-case-result.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBMISSIONTESTCASERESULT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBMISSIONTESTCASERESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBMISSIONTESTCASERESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBMISSIONTESTCASERESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBMISSIONTESTCASERESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBMISSIONTESTCASERESULT actions', async () => {
      const expectedActions = [
        {
