...
export const ProblemDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="cpojApp.problem.delete.question">
        <Translate contentKey="cpojApp.problem.delete.question" interpolate={{ id: problemEntity.id }}>
