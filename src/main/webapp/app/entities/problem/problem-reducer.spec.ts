...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './problem.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROBLEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROBLEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROBLEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROBLEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROBLEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROBLEM actions', async () => {
      const expectedActions = [
        {
